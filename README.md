...
This repository is updated regularly — daily, after each class session — with new material, exercises, and projects as the course moves forward.

> **Learn → Practice → Build → Share → Repeat**

---

⭐ Follow my journey as I grow from Python fundamentals to Deep Learning.
